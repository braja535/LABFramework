...
if __name__ == '__main__':
    ...
    netcopy( "10.31.56.44" , 'c:\\documents', 'c:\\transferred')

    # Move with account credentials.
    netmove("10.31.56.44", 'c:\\documents', 'c:\\transferred', 'Administrator', 'Fabricx@01')

    # Delete with another account.
    netdelete("10.31.56.44", 'c:\\transferred', 'DC2\Administrator', 'Fabricx@01')

    # Transfer files using different accounts, to multiple computers.
    accounts = [
        ('Administrator', 'Fabricx@01'),
        ('DC2\\administrator', 'Fabricx@01')]

    computers = ["10.31.56.44"]
